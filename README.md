...
Installing `openff-interchange-split` from the `conda-forge/label/openff-interchange_rc` channel can be achieved by adding `conda-forge/label/openff-interchange_rc` to your channels with:
...
Once the `conda-forge/label/openff-interchange_rc` channel has been enabled, `openff-interchange, openff-interchange-base` can be installed with `conda`:
...
```
conda search openff-interchange --channel conda-forge/label/openff-interchange_rc
```

or with `mamba`:

```
mamba search openff-interchange --channel conda-forge/label/openff-interchange_rc
```
...
mamba repoquery search openff-interchange --channel conda-forge/label/openff-interchange_rc

# List packages depending on `openff-interchange`:
mamba repoquery whoneeds openff-interchange --channel conda-forge/label/openff-interchange_rc

# List dependencies of `openff-interchange`:
mamba repoquery depends openff-interchange --channel conda-forge/label/openff-interchange_rc
```
