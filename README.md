...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/openff-interchange-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/openff-interchange-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
Installing `openff-interchange` from the `conda-forge/label/openff-dev` channel can be achieved by adding `conda-forge/label/openff-dev` to your channels with:
...
Once the `conda-forge/label/openff-dev` channel has been enabled, `openff-interchange, openff-interchange-base` can be installed with `conda`:
...
```
conda search openff-interchange --channel conda-forge/label/openff-dev
```

or with `mamba`:

```
mamba search openff-interchange --channel conda-forge/label/openff-dev
```
...
mamba repoquery search openff-interchange --channel conda-forge/label/openff-dev

# List packages depending on `openff-interchange`:
mamba repoquery whoneeds openff-interchange --channel conda-forge/label/openff-dev

# List dependencies of `openff-interchange`:
mamba repoquery depends openff-interchange --channel conda-forge/label/openff-dev
```
